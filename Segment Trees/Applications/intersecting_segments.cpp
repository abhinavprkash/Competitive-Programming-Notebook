/*
    Given 2n points representing ranges find for each number, number of segment intersecting with it.
    Example:    n=2 and array=[1,2,1,2]. 1 and 2 intersect hence answer is [1,1] for 1 and 2.
*/
#include <bits/stdc++.h>
using namespace std;
using ll = long long;
